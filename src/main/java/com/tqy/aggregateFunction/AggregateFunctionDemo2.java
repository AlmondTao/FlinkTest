...
public class AggregateFunctionDemo2 {
    public static void main(String[] args) throws Exception {
        ...
        env
                ...
                .aggregate(new MyAggregateFunction(),new MyWindow())
    ...
    //窗口函数的输入泛型是聚合函数输出泛型
    public static class MyWindow extends ProcessWindowFunction<String,String,String, TimeWindow> {
